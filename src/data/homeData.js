...
export default {
  corePrincipals: [
    {name: 'VISION', text: dummyText, image: dummyImage},
    {name: 'MISSION', text: dummyText, image: dummyImage},
    {name: 'CHARTER', text: dummyText, image: dummyImage},
    {name: 'CREATION COMPASS', text: dummyText, image: dummyImage},
    {name: 'METAWHEEL', text: dummyText, image: dummyImage},
    {name: 'INITIATIVES', text: dummyText, image: dummyImage}
  ],
  volunteerVideoURL: '/videos/SampleVideo_720x480_5mb.mp4' // replace this with official video url
};
