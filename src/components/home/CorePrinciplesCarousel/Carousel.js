...
class Carousel extends Component {
    ...
    handleUpdateTimeout() {
        ...
        const slideFunc = direction === Direction.left || direction === Direction.up ?
            ...
            <div>
                <div className="carouselRoot">
                    ...
                    <div className="carouselControls">
                        ...
                        <button 
                            tabIndex="0" 
                            className={`carouselArrowButton ${prevButtonClass}`}
                            onClick={this.handlePrevClick}
                        />
                        <button 
                            tabIndex="0" 
                            className={`carouselArrowButton ${nextButtonClass}`}
