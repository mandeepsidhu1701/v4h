          ...
          <Grid container className={classes.gridContainerPadding}>
            <Grid item xs={12} sm={12} md={4}>
              <p className={`${classes.paragraphTextSmall} ${classes.siteDescriptionContainer}`}>
                HCN is a "Metamorphic Media" site aimed at elevating Global Consciousness via valuable quotes,
                affirmations, articles, videos and visualizations. Content is being generated to integrate with the
                forth coming "Sanctuary Project" and the services of human and global advancement architecture that the
                project offers. Engage with HCN and holistically advance; physically, mentally, emotionally and
                spiritually, to possess greater awareness and a surplus capacity to effortlessly help others and the
                progression of the planet. HCN is also a platform that brings together a network of like minded
                Conscious Creatures (conscious; consumers, producers, creators and communicators) as a collective
                representation to transform our world. Consume, Contribute, Disperse, and Sponsor media which uplifts
                the human spirit, empowers people and nurtures the planet.
              </p>
              <p className={classes.paragraphTextSmall}>
                ...
                evolve beyond our current state to collectively create Inter-Generational Global Family Wealth. Connect
                as a Conscious Creature on this site and learn more of what that means!{' '}
                ...
                <Grid item xs={12} sm={12} md={5}>
                  <Grid container direction="column" className={classes.aboutUsContainer}>
                    ...
                    <Grid item className={`${classes.fontBase} ${classes.aboutUsText}`}>
                      HCN and the Sanctuary Project are the ofspring of Vision for Humanity, a New Zealand charitable
                      trust with aims to create a Global Family and a Successful Planet. Long term, HCN is intended to
                      disperse content from The Urban Sanctuary's health and wellbeing professionals, guides and
                      workshops.
                    </Grid>
                  </Grid>
                </Grid>
                  ...
                  <Grid container direction="column" className={classes.metamorphicMediaContainer}>
                    ...
                    <Grid item>
                      <div className={`${classes.fontBase} ${classes.metamorphicMediaText}`}>
                        Elevating Global Consciousness through all forms of information and entertainment. Visualise a
                        world where the media induces mental / emotional well-bring and social cohesion.
                      </div>
                    </Grid>
                    <Grid item>
            ...
            <Grid item xs={12} sm={12} md={6}>
              <div className={classes.videoParentContainer}>
                <div className={classes.videoContainer}>
                  <span className={`${classes.fontBase} ${classes.videoContainerTitle}`}>
